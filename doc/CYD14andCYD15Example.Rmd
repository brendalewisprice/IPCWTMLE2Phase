...
This vignette demonstrates the application of IPCW-TMLE to data sets simulated to mimic two phase 3 clinical trials investigating the vaccine efficacy of a dengue vaccine.  For comparison, the Breslow-Holubkov approach for two-phase sampling estimation is also demonstrated.
