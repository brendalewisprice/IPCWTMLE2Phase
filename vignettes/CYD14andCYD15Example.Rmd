...
IPCW-TMLE estimates of $\Psi_1$, $\Psi_0$, and $\theta$ are obtained using the methods described in Price and Gilbert (2020), and Breslow-Holubkov estimates are obtained using the "tps" function from the package _osDesign_.
...
For application of the Breslow-Holubkov approach for estimation in two-phase studies, the "tps" function from the _osDesign_ package can be used along with some additional steps utilizing the delta method to obtain the same estimates.  
