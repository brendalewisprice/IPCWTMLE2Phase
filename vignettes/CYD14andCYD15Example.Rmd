...
references:
- id: Price2019
  title: Comparing targeted minimum loss-based and Breslow-Holubkov methodology for two-phase sampling data designs
  author:
  - family: Price
    given: Brenda
...
This vignette demonstrates the application of IPCW-TMLE to data sets simulated to mimic two phase 3 clinical trials investigating the vaccine efficacy of a dengue vaccine using the approach in @Price2019.  For comparison, the Breslow-Holubkov approach for two-phase sampling estimation is also demonstrated.
